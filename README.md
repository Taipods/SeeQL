# SeeQL
## Description: ([Living Document Link](https://docs.google.com/document/d/12MFihRglfg_T3lWZXr646zodLR8koEVt0BNqj5beBrc/edit?usp=sharing))
...
- Visualize ER Diagrams via `CREATE TABLE`s
...
## Release Notes
Current Tag: [v1.0.0](https://github.com/Taipods/SeeQL/releases/tag/v1.0.0)
